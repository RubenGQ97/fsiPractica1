...
def search_ramificacion(problem):
    return graph_search(problem,ramificacion())

def search_ramificacionConSubestimacion(problem):
    return graph_search(problem,ramificacionConSubestimacion(problem))
